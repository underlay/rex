import { NamedNode, BlankNode, Literal, IRIs } from "n3.ts"
...
export function isBlankNodeConstraintResult(
	...
	return result.type === "NodeTest" && isBlankNodeConstraint(result.shapeExpr)
}
