import { type, string, literal, union, exact, } from "io-ts/es6/index.js";
import { iriNodeKind, nonLiteralNodeKind, literalNodeKind, dataType, valueSet, numericFacet, stringFacet, objectValue, IriStem, IriStemRange, LiteralStem, LiteralStemRange, Language, LanguageStem, LanguageStemRange, } from "./nodeConstraint.js";
const rdfLangString = "http://www.w3.org/1999/02/22-rdf-syntax-ns#langString";
const xsdString = "http://www.w3.org/2001/XMLSchema#string";
const xsdInteger = "http://www.w3.org/2001/XMLSchema#integer", xsdNonPositiveInteger = "http://www.w3.org/2001/XMLSchema#nonPositiveInteger", xsdNegativeInteger = "http://www.w3.org/2001/XMLSchema#negativeInteger", xsdLong = "http://www.w3.org/2001/XMLSchema#long", xsdInt = "http://www.w3.org/2001/XMLSchema#int", xsdShort = "http://www.w3.org/2001/XMLSchema#short", xsdByte = "http://www.w3.org/2001/XMLSchema#byte", xsdNonNegativeInteger = "http://www.w3.org/2001/XMLSchema#nonNegativeInteger", xsdUnsignedLong = "http://www.w3.org/2001/XMLSchema#unsignedLong", xsdUnsignedInt = "http://www.w3.org/2001/XMLSchema#unsignedInt", xsdUnsignedShort = "http://www.w3.org/2001/XMLSchema#unsignedShort", xsdUnsignedByte = "http://www.w3.org/2001/XMLSchema#unsignedByte", xsdPositiveInteger = "http://www.w3.org/2001/XMLSchema#positiveInteger";
const xsdDecimal = "http://www.w3.org/2001/XMLSchema#decimal", xsdFloat = "http://www.w3.org/2001/XMLSchema#float", xsdDouble = "http://www.w3.org/2001/XMLSchema#double";
const TypedLiteral = (value) => type({
...
const integer = TypedLiteral(union([
    literal(xsdInteger),
...
const integerRanges = Object.freeze({
    [xsdInteger]: [-Infinity, Infinity],
    [xsdNonPositiveInteger]: [-Infinity, 0],
    [xsdNegativeInteger]: [-Infinity, -1],
    [xsdLong]: [-9223372036854775808, 9223372036854775807],
    [xsdInt]: [-2147483648, 2147483647],
    [xsdShort]: [-32768, 32767],
    [xsdByte]: [-128, 127],
    [xsdNonNegativeInteger]: [0, Infinity],
    [xsdUnsignedLong]: [0, 18446744073709551615],
    [xsdUnsignedInt]: [0, 4294967295],
    [xsdUnsignedShort]: [0, 65535],
    [xsdUnsignedByte]: [0, 255],
    [xsdPositiveInteger]: [1, Infinity],
});
...
const encodeInteger = ({ value }) => parseInt(value);
const decimal = TypedLiteral(literal(xsdDecimal));
const isDecimal = (input) => decimal.is(input) && decimalPattern.test(input.value);
const encodeDecimal = ({ value }) => parseFloat(value);
const float = TypedLiteral(literal(xsdFloat));
const isFloat = (input) => float.is(input) &&
    (input.value === "NaN" ||
        input.value === "INF" ||
        input.value === "-INF" ||
        decimalPattern.test(input.value));
const encodeFloat = ({ value }) => value === "NaN"
    ? NaN
    : value === "INF"
        ? Infinity
        : value === "-INF"
...
const isDouble = (input) => double.is(input) &&
    (input.value === "NaN" ||
        input.value === "INF" ||
        input.value === "-INF" ||
        decimalPattern.test(input.value));
const encodeDouble = ({ value }) => value === "NaN"
    ? NaN
    : value === "INF"
        ? Infinity
        : value === "-INF"
...
//# sourceMappingURL=nodeSatisfies.js.map