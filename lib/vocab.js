...
const rexIn = "http://underlay.org/ns/rex#in", rexKey = "http://underlay.org/ns/rex#key", rexWith = "http://underlay.org/ns/rex#with", rexMeta = "http://underlay.org/ns/rex#meta", rexSort = "http://underlay.org/ns/rex#sort", rexFirst = "http://underlay.org/ns/rex#first", rexLast = "http://underlay.org/ns/rex#last", rexGreatest = "http://underlay.org/ns/rex#greatest", rexLeast = "http://underlay.org/ns/rex#least", rexEarliest = "http://underlay.org/ns/rex#earliest", rexLatest = "http://underlay.org/ns/rex#latest", rexAll = "http://underlay.org/ns/rex#all", rexAny = "http://underlay.org/ns/rex#any";
